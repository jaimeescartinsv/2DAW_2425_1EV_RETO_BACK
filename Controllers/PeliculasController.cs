...
public class PeliculasController : ControllerBase
{
    private static List<Pelicula> Peliculas = new List<Pelicula>
    {
        ...
        new Pelicula { PeliculaId = 6, Title = "Pulp Fiction", Description = "La vida de varios personajes de Los Ángeles se entrelaza en una serie de historias violentas y absurdas que exponen la crudeza y lo impredecible del destino.", Duration = 154, ImageUrl = "https://image.tmdb.org/t/p/original/hNcQAuquJxTxl2fJFs1R42DrWcf.jpg" },
        ...
        new Pelicula { PeliculaId = 11, Title = "Gladiator", Description = "Máximo Décimo Meridio, un general romano traicionado y convertido en esclavo, busca vengar la muerte de su familia en la arena del Coliseo.", Duration = 155, ImageUrl = "https://image.tmdb.org/t/p/original/90QFOG5zSN4cbrIVs4DL4ePAuA5.jpg" },
        ...
        new Pelicula { PeliculaId = 13, Title = "The Lion King", Description = "Simba, un joven león, debe reclamar su lugar como rey tras la trágica muerte de su padre, enfrentando su destino y superando sus miedos.", Duration = 88, ImageUrl = "https://image.tmdb.org/t/p/original/eGfq90BF8QGCMpncF2ag0lGTgKk.jpg" },
        ...
        new Pelicula { PeliculaId = 19, Title = "Star Wars: A New Hope", Description = "Luke Skywalker, un joven granjero, se une a un grupo de rebeldes en su lucha contra el Imperio Galáctico y su superarma, la Estrella de la Muerte.", Duration = 121, ImageUrl = "https://image.tmdb.org/t/p/original/ahT4ObS7XKedQkOSpGr1wQ97aKA.jpg" },
        new Pelicula { PeliculaId = 20, Title = "The Green Mile", Description = "Un guardia de prisión descubre que un preso en el corredor de la muerte tiene un don especial, lo que le hace cuestionar la justicia de su ejecución.", Duration = 189, ImageUrl = "https://image.tmdb.org/t/p/original/aBQiJRxGRrX0mXFMjxyzWYFtEnf.jpg" }
    };
