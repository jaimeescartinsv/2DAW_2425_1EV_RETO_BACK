...
public class PeliculasController : ControllerBase
{
    private static List<Pelicula> Peliculas = new List<Pelicula>
    {
        ...
        new Pelicula { PeliculaId = 19, Title = "La guerra de las galaxias", Description = "Luke Skywalker, un joven granjero, se une a un grupo de rebeldes en su lucha contra el Imperio Galáctico y su gran arma, la Estrella de la Muerte.", Director = "George Lucas", Genero = "Aventura, Acción, Ciencia ficción", Clasificacion = "7", Duration = 121, ImageUrl = "https://image.tmdb.org/t/p/original/hkHIcwbe39ywsT3CeJcFZT1RozG.jpg", CartelUrl = "https://image.tmdb.org/t/p/original/4rjkUgFPDrQEOr1NnZJ5FSKzCIX.jpg" },
